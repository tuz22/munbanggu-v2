            ...
            <Container>
                <header className="detail-header">
                    <div className="item-info">
                        <div className="badge">
                            <span className="discount">{discount === null ? '' : discount + '% SALE'}</span>
                            <BadgeState
                    ...
                    <div className="item-order">
                        <dl className="shipping">
                            <dt>배송정보</dt>
                            <dd>
                                3,000원 (30,000원 이상 구매 시 무료) <br /> 오후 1시 당일배송마감
                            </dd>
                        </dl>
                    ...
                    <BasicGuid>
                        ...
                        <ul className="guide-cautions">
                            ...
                            <li>
                                ...
                                등을 공급받은 날로부터 3개월 이내,
                                <br />그 사실을 안 날 또는 알 수 있었던 날로부터 30일 이내에 교환 및 반품이 가능합니다.
                            </li>
                            <li>
                            ...
                            <li>
                                고객님의 단순변심에 의한 교환/반품일 경우에는 교환/반품 배송비(왕복 배송비) 6,000원을
                                고객님께서 부담하셔야 합니다.
                            </li>
                            <li>반송지 : 경기도 파주시 문산읍 돈유2로 105(선유리 1375-5) 배민문방구 물류센터</li>
                        </ul>
                        <h4 className="guide-title">환불안내</h4>
                        <p className="guide-cautions">
